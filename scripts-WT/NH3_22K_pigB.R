...
dat.22K.end <- dat.summ[dat.summ$elapsed.time == 161, ] # cum emis
dat.22K.summ <- left_join(dat.summ, dat.fluxtime, by = 'elapsed.time') # flux

# # data frames for GitHub use
# write.csv(dat.22K, '../data-NH3/pigB.A.csv')
# write.csv(dat.22K.end, '../data-NH3/pigB.B.csv')
# write.csv(dat.22K.summ, '../data-NH3/pigB.C.csv')
