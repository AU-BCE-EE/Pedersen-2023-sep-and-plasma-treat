...
dat.22I.end <- dat.summ[dat.summ$elapsed.time == 161, ] # cum emis
dat.22I.summ <- left_join(dat.summ, dat.fluxtime, by = 'elapsed.time') # flux

# # data frames for GitHub use
# write.csv(dat.22I, '../data-NH3/pigA.A.csv')
# write.csv(dat.22I.end, '../data-NH3/pigA.B.csv')
# write.csv(dat.22I.summ, '../data-NH3/pigA.C.csv')
